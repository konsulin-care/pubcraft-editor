...
generate_env_js() {
    ...
    local ALLOWED_VARS="VITE_ORCID_CLIENT_ID VITE_ORCID_REDIRECT_URI VITE_GITHUB_CLIENT_ID VITE_GITHUB_REDIRECT_URI VITE_APP_NAME VITE_APP_VERSION VITE_DEBUG_MODE VITE_GITHUB_API_BASE_URL VITE_GITHUB_TOKEN_URL VITE_ORCID_API_BASE_URL VITE_ORCID_SCOPE VITE_ORCID_TOKEN_URL VITE_BYPASS_AUTH"
